...
def render_ev_legend():
    ...
    <div class="ev-legend-box">
        ...
        <span style="font-size:0.85rem; margin-left:10px;"><span style="color:#be185d; font-weight:900;">🚀 展開の神</span> : 展開利あり & 勝率5%↑ & オッズ10~100倍 (ROI: 105%🏆)</span>
...
def main():
    ...
    st.markdown(f"""
        <div class="header-container">
            ...
            <div class="header-content">
                <h1 class="header-title">KaiのゆるっとAI<br><span class="beta-badge">鋭意開発中！</span></h1>
    ...
    if st.session_state.view_mode == 'list' and st.session_state.scan_results:
        ...
        with st.expander("🚀 展開の神 (ROI 105%〜)", expanded=st.session_state.expander_states['pace']):
